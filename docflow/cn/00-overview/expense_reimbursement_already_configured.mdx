...
工作空间、文件类别、审核规则库属于**一次性基础配置**，完成后即可持续复用。在日常业务中，财务人员只需通过 API 重复以下三步：
...
<Tabs>
  ...
  <Tab title="Java">
    ...
    public class ExpenseReimbursementConfigured {
        ...
        private static final String FILES_DIR = "../sample_files/费用报销";
...
开始上传待处理文件...
[步骤1] 文件上传成功  name=报销申请单.XLS  batch_number=<batch_number>
