...
description: "How to obtain and use API access credentials"
---
...
DocFlow uses [TextIn](https://www.textin.com/) accounts.

Please register on [TextIn](https://www.textin.com/) first, then obtain `x-ti-app-id` and `x-ti-secret-code` on the [TextIn Homepage - Account & Billing - Account & Developer Information](https://www.textin.com/console/dashboard/setting) page for request authentication.
