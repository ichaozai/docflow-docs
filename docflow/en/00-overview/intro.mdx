...
**Docflow Document Automation Platform** is an AI-driven enterprise-level document automation processing platform launched by TextIn by HeHe Information.

Leveraging HeHe Information's industry-leading document parsing and understanding capabilities, it supports **intelligent collection**, **document parsing**, **document classification**, **information extraction**, and **intelligent review** of various format documents from both domestic and international sources. It provides efficient and accurate document processing solutions for banking credit, financial shared service centers, logistics customs clearance, insurance claims, and other industry enterprises. Through stable and easy-to-use APIs, you can efficiently integrate DocFlow into various business systems to achieve full-process automation from document collection to information extraction, significantly reducing manual input and review costs.

![product](../images/01.png)

## 02 Core Value

In the era of information explosion, enterprises need to process massive amounts of contracts, invoices, reports, application forms, and other documents daily. Traditional manual methods are not only time-consuming and labor-intensive but also prone to errors. **Docflow Document Automation Platform** helps enterprises easily address document management challenges and significantly improve work efficiency and data accuracy.

### 2.1 Full-Process Automation

- From file upload to result retrieval, the entire process is intelligently completed by the system with almost zero manual intervention, greatly improving document processing efficiency.

### 2.2 Efficient and Accurate Extraction

- Massive documents are parsed and extracted in seconds, greatly shortening processing cycles and improving document processing efficiency.
- Based on specialized large model capabilities, through document preprocessing mechanisms such as optimizing image quality and intelligently analyzing document structure, recognition accuracy is greatly improved to meet document processing needs in different scenarios.
...
- Supports receiving documents through multiple channels such as scanners, email, API interfaces, and seamlessly transferring extracted data to various automation systems and business processes such as ERP, RPA, OMS, etc.
...
After users complete login, they can create corresponding workspaces according to different business scenarios to manage file categories and documents under different business scenarios.
...
<CardGroup cols={2}>
  <Card title="SaaS Platform" icon="sparkles" href="https://docflow.textin.com/">
  ...
  <Card title="API" icon="sparkles" href="/api-reference/%E4%B8%8A%E4%BC%A0%E6%96%87%E4%BB%B6">
    Flexible use of different programming languages, supports highly customized interfaces
  </Card>
  <Card title="Docflow Official Website" icon="sparkles" href="https://www.textin.com/product/textin_docflow">
    More abundant product information, welcome to click to learn more
  </Card>
  <Card title="Contact Us" icon="sparkles" href="https://www.textin.com/contact?type=27&sub_type=1">
    More cooperation information, welcome to inquire
  </Card>
</CardGroup>
