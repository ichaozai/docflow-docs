...
<Tip>
  This document explains how to quickly access the Docflow workflow through APIs using examples.\
  However, if you haven't used Docflow on the Web UI before, we recommend you first upload files on the [Web page](https://docflow.textin.com/) to intuitively experience how Docflow works.
</Tip>
...
Please log in first and go to [TextIn Console - Account & Developer Information](https://www.textin.com/console/dashboard/setting) to obtain your `x-ti-app-id` and `x-ti-secret-code`.
...
<Tip>
  The example below outputs document field extraction results. Parsing of other information can refer to other documentation sections.
</Tip>
