...
<Tip>
  This document provides examples on how to quickly integrate with the DocFlow workflow via API.\
  If you have not used DocFlow in the Web UI before, we recommend uploading a file on the [Web page](https://docflow.textin.com/) first to get a clear idea of how DocFlow works.
</Tip>
