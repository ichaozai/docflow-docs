...
The document extraction function recognizes key field information in documents based on file classification field configuration. Each field contains key-value pairs and position coordinate information.
