...
When using DocFlow API, if file category names are in Chinese or other non-English characters, directly passing the original category names may cause the following issues:
