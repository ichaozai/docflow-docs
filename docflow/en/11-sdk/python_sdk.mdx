...
| `client.category.fields`      | Category Field Management  | `add()`, `list()`, `update()`, `delete()` |
| `client.category.tables`      | Category Table Management  | `add()`, `list()`, `update()`, `delete()` |
| `client.category.samples`     | Category Sample Management | `upload()`, `list()`, `download()`, `delete()` |
