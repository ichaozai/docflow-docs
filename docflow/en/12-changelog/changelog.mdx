...
Process multiple objects in a single request. All batch endpoints use **all-or-nothing** semantics — if any item fails validation, the entire batch is rejected.

| Endpoint | Description |
|----------|-------------|
| [Batch Add File Category Fields](/api-reference/file-category/batch-add-file-category-fields) | Create up to 100 fields at once |
| [Batch Update File Category Fields](/api-reference/file-category/batch-update-file-category-fields) | Update multiple field configs |
| [Batch Add File Category Tables](/api-reference/file-category/batch-add-file-category-tables) | Create tables (with embedded fields) |
| [Batch Update File Category Tables](/api-reference/file-category/batch-update-file-category-tables) | Update multiple table configs |
| [Batch Upload Category Samples](/api-reference/file-category-samples/batch-upload-category-samples) | Upload multiple samples (up to 10) |
| [Batch Download Category Samples (ZIP)](/api-reference/file-category-samples/batch-download-category-samples-zip) | Download samples as ZIP |
