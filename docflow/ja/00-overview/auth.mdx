...
DocFlow は [TextIn](https://www.textin.com/) アカウントを使用します。

まず [TextIn](https://www.textin.com/) に登録し、[TextIn ホーム - アカウントと請求 - アカウントと開発者情報](https://www.textin.com/console/dashboard/setting) ページで、リクエスト認証に使用する `x-ti-app-id` と `x-ti-secret-code` を取得してください。
