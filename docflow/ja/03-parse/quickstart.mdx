---
title: "クイックスタート"
description: "API で文書解析機能をすばやく連携するための参考例"
---


<Tip>
  Docflow は中核の文書解析サービスとして [xParse](https://www.textin.com/market/detail/pdf_to_markdown) を使用しています。PDF、Word、一般的な画像形式の文書を、テキスト、表、見出し階層、数式、手書き文字、画像情報を含む構造化データへ高精度に変換し、後続の自動処理と分析に利用できます。
