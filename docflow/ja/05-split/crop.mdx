...
| `child_files[].from_parent_position_list` | array   | Coordinates of cropping area in original image, refer to [座標系 Description](../03-parse/coordinate) |
