---
title: "クイックスタート"
description: "API で文書抽出機能をすばやく連携するための参考例"
---
...
`files[].pages[]` の `width/height/angle/dpi` と `fields[].position[].vertices` を組み合わせると、フロントエンドでフィールド枠を正確に描画できます。詳細は [解析結果の可視化](../03-parse/visualization) を参照してください。
...
- [基本フィールド情報](./fields) - Detailed explanation of basic field information structure and processing methods
- [テーブルフィールド情報](./tables) - Detailed explanation of table field information structure and processing methods
- [印影情報](./stamps) - Detailed explanation of stamp information structure and processing methods
- [手書き情報](./handwritings) - Detailed explanation of handwriting information structure and processing methods
- [特定フィールドを抽出](./extract_specific_fields) - Extract additional fields or re-extract existing fields for tasks that have completed extraction
