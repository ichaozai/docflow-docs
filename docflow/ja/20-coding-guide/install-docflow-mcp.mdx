...
<Tabs>
  ...
  <Tab title="VS Code Chat">
    ...
    2. サーバー URL として `http://docflow.textin.com/textin-docs/mcp` を入力します
...
<Warning>
  ネットワークから `docflow.textin.com` にアクセスできることを確認してください。ネットワーク制限がある場合は、管理者に連絡してこのドメインを許可リストに追加してください。
</Warning>
